...
mycmap = ListedColormap(["black","lightblue", "lightblue", "firebrick", "firebrick","darkorange","mediumaquamarine", "mediumaquamarine", "firebrick", "lemonchiffon","black","cornflowerblue",])
...
def main() -> None:
    ...
    #print("scp -r AP50860@phoebe.logti.etsmtl.ca:../../../data/users/mathilde/ccnn/CDA/"+args.result_fold+'/slice81014_73.png ./seg/whs/')
