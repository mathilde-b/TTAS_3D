...
TRN = results/ivdsag/cdaim
#TRN = results/ivdsag/sfda_select
TRN = results/ivdsag/sfda_selectim
TRN = results/ivdsag/fooim
...
results/ivdsag/cesourceim: OPT =  --target_losses="$(L_OR)" \
	    --do_asd True --mode makeim  --l_rate 0 --pprint --n_epoch 1 --saveim True --entmap \

results/ivdsag/sfda_selectim: OPT =  --target_losses="$(L_OR)" \
	   --mode makeim --model_weights="results/ivdsag/sfda_select/best_3d.pkl" --do_asd True --l_rate 0 --pprint --n_epoch 1 --saveim True --entmap \

results/ivdsag/cdaim: OPT =  --target_losses="$(L_OR)" \
	   --do_asd True --saveim True --entmap --mode makeim   --l_rate 0 --pprint --n_epoch 1 --model_weights="/data/users/mathilde/ccnn/CDA/results/ivdsag/CSizewTag_tmp/best_3d.pkl" \
...
results/ivdsag/fooim: OPT =  --target_losses="$(L_OR)" \
	   --val_target_folders="$(T_DATA)" --model_weights="results/ivdsag/sfda/best_3d.pkl" --do_asd True --mode makeim  --l_rate 0 --pprint --n_epoch 1 \
...
$(TRN) :
	$(CC) $(CFLAGS) main_sfda.py --batch_size 20 --n_class 2 --workdir $@_tmp --target_dataset "$(B_FOLD)"  \
                ...
                --lr_decay 0.9 --metric_axis 1  --n_epoch 150 --dice_3d --l_rate 1e-6 --lr_decay_epoch 50 --weight_decay 1e-3 $(OPT) $(DEBUG)\
